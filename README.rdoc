...
4. Click on the Note div to read full Note
...
14. Show note imge tag only if file exists

15. New note typo upload file - DONE

16. Fix navbar - DONE

17. Paperclip warning when wrong filesize, add filesize text in the form
